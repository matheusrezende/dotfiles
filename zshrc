...
# ALIASES
alias dave='cd ~/www/nfq/dave'
alias mymoxy="cd ~/www/itinance/mymoxy"
alias nachtplan="cd ~/www/itinance/nachtplan"
alias mymox-api="cd ~/www/itinance/mymoxy-api"
alias heidi="cd ~/www/nfq/heidi/"
alias frank="cd ~/www/nfq/frank/"
alias merlin="cd ~/www/nfq/merlin/"
...
alias git='git '
alias back='checkout -'
alias trunk='checkout develop && git pull'
